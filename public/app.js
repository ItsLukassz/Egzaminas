...
var defaultimg = 'https://critics.io/img/movies/poster-placeholder.png';
...
function _getMovie() {
  _getMovie = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
    var querys, responce, data;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            temp.innerHTML = "<p> </p>";
            querys = document.getElementById('tekstas').value;
            _context.next = 4;
            return fetch("".concat(url).concat(querys, "&apikey=").concat(apikey));
          ...
          case 7:
            ...
            poster.innerHTML = "<img src=\"".concat(defaultimg, "\">"); // tikrinam ar surado filma
            ...
            if (data.Response == "False") {
              ...
              Director.innerHTML = "<p> Director: ".concat(data.Director, " </p>");
              Actors.innerHTML = "<p> Actors: ".concat(data.Actors, " </p>"); // Tikrinam ar filmas turi posteri

              if (data.Poster == 'N/A') {
                // jei ne naudojam default image
                poster.innerHTML = "<img src=\"".concat(defaultimg, "\">");
              } else {
                // jei turi, naudojam api image
                poster.innerHTML = "<img src=\"".concat(data.Poster, "\">");
              }
            }
